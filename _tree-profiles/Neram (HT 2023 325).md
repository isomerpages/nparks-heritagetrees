...
<p>The name Keruing also refers to the timber from some <em>Dipterocarpus</em> species, and is used for building simple structures such flooring, staircases, paneling, boxes and crates. The timber from Neram is used by locals to build large padi-husking tables in their native range.</p>
